...
-- Description: Full baseline schema for Supabase POS System
-- Version: 2.4
...
-- Note: Created before items because items references inventory_items(id)
...
BEGIN
  -- Categories
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.categories FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.inventory_categories FOR ALL USING (true);

  -- Items & Related
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.items FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.inventory_items FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.recipes FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.recipe_ingredients FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.item_portions FOR ALL USING (true);

  -- Tables & Zones
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.zones FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.tables FOR ALL USING (true);

  -- Orders
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.orders FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.order_items FOR ALL USING (true);

  -- Inventory
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.inventory_transactions FOR ALL USING (true);

  -- Expenses
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.expense_categories FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.expenses FOR ALL USING (true);

  -- Employees
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.employees FOR ALL USING (true);

  -- Shifts
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.shifts FOR ALL USING (true);

  -- Stations
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.stations FOR ALL USING (true);
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.station_mappings FOR ALL USING (true);

  -- License
  CREATE POLICY IF NOT EXISTS "Allow public access" ON public.license_keys FOR ALL USING (true);
END $$;
...
INSERT INTO public.schema_version (version, description) VALUES
  ('2.4', 'Initial baseline schema migration for Supabase POS System')
